...
/* ThumbySNES: shrunk from [24000] to [16384]. SNES HW echo max delay is
 * 240 ms (delay register 0..15, 16 ms per step); at 32 kHz stereo that's
 * 15360 samples. 16384 gives 1 KB safety margin. Saves 30 KB BSS. */
int Echo [16384];
