...
//SDD1
#include "sdd1emu.h"
/* ThumbySNES: SDD1 decompression staging buffer, shrunk from 64 KB to
 * 16 KB. Gated by Settings.SDD1, which stays FALSE for every cart in our
 * support set — SDD1 is used only by Street Fighter Alpha 2 and Star
 * Ocean, listed as non-goals in PLAN.md §9. Saves 48 KB BSS. */
uint8 buffer[0x4000];
//SDD1//
